...
{
    vm->RegisterFunction("Get_Version", "moaUtil", Get_Version);
    vm->RegisterFunction("GetItemsByType", "moaUtil", GetItemsByType);
    vm->RegisterFunction("MergeFormArrays", "moaUtil", MergeFormArrays);
    vm->RegisterFunction("removeItemsByFilters", "moaUtil", removeItemsByFilters);
    return true;
}
